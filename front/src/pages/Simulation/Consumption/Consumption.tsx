    ...
    async (): Promise<void> => {
      try {
        ...
        const metricsResponse =
          await api.get("/metrics/station/daily");
      ...
      try {
        ...
        if (mode === "daily") {
          const simulationResponse =
            await api.post("/simulation/daily");
          ...
          const metricsResponse =
            await api.get("/metrics/station/hourly");

          setChartData(
            metricsResponse.data.energy_by_hour
          );
